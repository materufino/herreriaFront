...
//Lista de artefactos disponibles
export const listaArtefactos = [    
    {
        nombre: 'Daga',
...
//para saber qué hay en cada categoría hay
...
//para remover propiedades duplicadas
function onlyUnique(value, index, self) { 
    return self.indexOf(value) === index;
}
// Especialidades artefactos
const especialidades = todasLasEspecialidades.filter(onlyUnique).sort();

// Tod os los nombres de los artefactos
...
export default {encargos, listaArtefactos};
