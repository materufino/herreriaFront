...
const CardTareas = ({ id, task, product_type, product_subtype, order_status, obs, sub_task1, sub_task2, sub_task3, sub_task1_status, sub_task2_status, sub_task3_status, textoBoton, readOnly }) => {
